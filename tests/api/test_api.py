...
SETTLEMENT_CSV = "\n".join(
    [
        PLATFORM_A_HEADER,
        "SP-AAAA0001,2026-03-01,無線滑鼠,1,1000,55.30,944.70,2026-03-15,銷售",
        "SP-AAAA0002,2026-03-02,機械鍵盤,1,2500,138.25,2361.75,2026-03-16,銷售",
        ",2026-03-03,USB 集線器,1,680,37.60,642.40,2026-03-17,銷售",
        "SP-UNKNOWN9,2026-03-04,不明商品,1,500,27.65,472.35,2026-03-18,銷售",
    ]
)
...
class TestIdempotency:
    ...
    def test_changed_file_still_skips_rows_it_already_has(self, client: TestClient) -> None:
        ...
        extended = SETTLEMENT_CSV + (
            "\nSP-AAAA0005,2026-03-05,新商品,1,900,49.77,850.23,2026-03-19,銷售"
        )
